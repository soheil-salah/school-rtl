<x-admin-app-layout>
    ...
    <div class="row">
        <div class="col-3">
            <a href="{{ route('admin.inqueries.read') }}" class="card border-0 zoom-in bg-success shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <i class="ti ti-checks text-light" style="font-size: 50px;"></i>
                        <p class="fw-semibold fs-3 text-light mb-1">المقروء</p>
                        <h5 class="fw-semibold text-light mb-0" id="unread-inquery-counter">{{ $count_unread_inqueries }}</h5>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-3">
            <div class="card border-0 zoom-in bg-danger shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <i class="ti ti-message-dots text-light" style="font-size: 50px;"></i>
                        <p class="fw-semibold fs-3 text-light mb-1">الغير مقروء</p>
                        <h5 class="fw-semibold text-light mb-0" id="inquery-counter">{{ $inqueies->count() }}</h5>
                        <span id="inquery-counter-res"></span>
                    </div>
                </div>
            </div>
        </div>
